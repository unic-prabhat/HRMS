...
<a href="<?php echo base_url();?>/circularprocess/Candidate_select/candidate_interview_view" class="btn btn-primary">Manage Interview</a>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('circularprocess/Candidate_select/create_interview') ?>
                          <div class="form-group row">
                            <label for="can_id" class="col-sm-2 col-form-label"><?php echo display('can_id') ?> *</label>

                            
                            <div class="col-sm-4">
                               <select name="can_id" id="c_id" class="form-control" onchange="SelectToLoad(this.value)" style="width: 260px">
                                    <option value="">--select id--</option>
                                <?php 
                                    foreach($dropdowninterview as $values){
                                ?>
...
<input type="text" name="job_adv_id" class="form-control">
                            </div>
                        </div>
