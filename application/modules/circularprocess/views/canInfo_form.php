...
$(document).ready(function(){var e=!1;$(".toggle").prev().append(' (<a href="#" class="toggleLink">Add more Info</a>)'),$(".toggle").hide(),$("a.toggleLink").click(function(){return e=!e,$(this).html(e?"Hide":"Add more Info"),$(this).parent().next(".toggle").toggle("slow"),!1})});
