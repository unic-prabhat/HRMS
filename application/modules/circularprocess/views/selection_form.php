...
<a href="<?php echo base_url();?>/circularprocess/Candidate_select/candidate_selection_view" class="btn btn-primary">Manage Selection</a>
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('circularprocess/Candidate_select/create_selection') ?>
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <select name="can_id" id="c_id" class="form-control" onchange="SelectToLoad(this.value)" style="width:300px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" name="pos_id" value="" style="width:300px">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="selection_terms" class="form-control"  placeholder="<?php echo display('selection_terms') ?>" id="selection_terms"  style="width:300px"></textarea>
                            </div>
                        </div> 
...
function SelectToLoad(id){
    ...
    $.ajax({
        url : "<?php echo site_url('circularprocess/Candidate_select/select_to_load/')?>" + id,
        type: "GET",
        dataType: "JSON",
