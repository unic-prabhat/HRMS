...
<ul  class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="#home"  role="tab" data-toggle="tab" class="btn btn-primary">Basic Information</a></li>
    <li><a href="#menu1"  role="tab" data-toggle="tab" class="btn btn-primary">Work Experience list</a></li>
    <li><a href="#menu2"  role="tab" data-toggle="tab" class="btn btn-primary">Educational Info list</a></li>
  </ul>
                        ...
                        <?php if (!empty($exp)) { ?>
                            ...
                            <?php foreach ($exp as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                    <?php if($this->permission->method('circularprocess','update')->access()): ?>
                                        <a href="<?php echo base_url("circularprocess/Candidate/update_workexperience_form/$que->can_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                         <?php endif; ?>
                                    
                                    <?php if($this->permission->method('circularprocess','delete')->access()): ?> 
                                        <a href="<?php echo base_url("circularprocess/Candidate/delete_workexperience/$que->can_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                        ...
                        <?php if (!empty($edu)) { ?>
                            ...
                            <?php foreach ($edu as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                     <?php if($this->permission->method('circularprocess','update')->access()): ?>
                                        <a href="<?php echo base_url("circularprocess/Candidate/update_can_eduifo_form/$que->can_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                         <?php endif; ?>
                                    
                                    <?php if($this->permission->method('circularprocess','delete')->access()): ?> 
                                        <a href="<?php echo base_url("circularprocess/Candidate/delete_can_edu_Info/$que->can_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
