...
Add More Holiday</button> 
<a href="<?php echo base_url();?>/leave/Leave/manage_holiday" class="btn btn-primary">Manage holiday</a>
...
//alert(diffDays);
        ...
        $('#start_date,#end_date,#no_of_days').keyup(calculation)
