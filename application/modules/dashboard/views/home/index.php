...
foreach ($transactiondduct as $dduct) {
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6" >
                    <div class="panel panel-bd lobidisable">
                        <div class="panel-body" style="padding-top: 0px">
                            ...
                            <div class="attendence" style="display:none;">
                ...
                <!-- <input type="button" name="add" value="Add Event" val="<?php echo $day;?>" class="add_event"/> -->
                            ...
                            <h4><span class="s_date" style="padding-left: 10px">Details <?php echo "$day $month $year";?></span></h4>
					...
					if(data.status){
						...
						$.each(data.data, function(index, value) {
						    if(i % 2 == 0){
								...
								html = html+'<div class="info4"><a style="display:none;" href="home/view_details/'+value.id+'" class="view" target="blank"><h3><i class="fa fa-eye"></i></h3></a><h4>Notice:'+value.notice_type+'</h4><p>Notice By:'+value.notice_by+'</p></div>';
							} 
							i++;
						});
					}else{
