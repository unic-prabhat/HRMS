                        ...
                        if ($value != "index.html" && $key != "dashboard/" && $key != "template/") {
                                ...
                                <div class="thumbnail">
                                  ...
                                  <div class="caption">
                                    ...
                                    <p>
                                        ...
                                        if ($rows->num_rows() > 0) { 
                                        ?>
                                        <a onclick="return confirm('Its Demo')"  href=#" class="btn btn-danger"><?php echo display("uninstall") ?></a> 
                                        <?php } else { ?>
                                            <button onclick="return confirm('Its Demo')" type="submit" class="btn btn-success" role="button"><?php echo display("install") ?></button>  
                                        <?php } ?>
                                        <a onclick="return confirm('Its Demo')" href="#" type="submit" class="btn btn-danger"><?php echo display("delete") ?></a>
                                    </p>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="thumbnail">
                                    ...
                                    <p><a onclick="return confirm('Its Demo')" href="#" type="submit" class="btn btn-danger"><?php echo display("delete") ?></a></p>
                                  </div>
                                </div>
                            </div>  
                            <?php
