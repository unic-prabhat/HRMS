...
<a href="<?php echo base_url();?>/payroll/Payroll/emp_salary_setup_view" class="btn btn-primary">Manage Salary Type</a>
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('payroll/Payroll/create_salary_setup') ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="sal_name" class="form-control" type="text" placeholder="<?php echo display('emp_sal_name') ?>" id="sal_name">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="emp_sal_type" class="form-control"  placeholder="<?php echo display('emp_sal_type') ?>" id="emp_sal_type" style="width:395px">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('emp_sal_type') ?></th>
                             <th><?php echo display('default_amount') ?></th>
                        ...
                        <?php if (!empty($emp_sl)) { ?>
                            ...
                            <?php foreach ($emp_sl as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    ?></td>
                                    <td><?php echo $que->default_amount; ?></td>                            
