...
<input name="att_id" type="hidden" value="<?php echo $data->att_id ?>">
   ...
   <div class="form-group row">
        <label for="emp_id" class="col-sm-3 col-form-label"><?php echo display('employee_id') ?> *</label>
        <div class="col-sm-9">
            <input type="text" name="employee_id" value="<?php echo $data->employee_id ?>" class="form-control"  readonly="readonly">
        </div>
    </div>
