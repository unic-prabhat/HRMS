...
<a href="<?php echo base_url();?>/noticeboard/Notice_controller/notice_view" class="btn btn-primary">Manage Notice</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"  style="background-color: green;color:white">
                ...
                <center><strong>Notice Form</strong></center>
            </div>
                    ...
                    <?= form_open_multipart('noticeboard/Notice_controller/create_notice') ?>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                           <textarea  name="notice_descriptiion" class=" form-control"></textarea>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                           <input type="text" name="notice_date" class="datepicker form-control" id="notice_date">
