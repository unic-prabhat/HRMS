...
<a href="<?php echo base_url();?>/loan/Loan/installmentView" class="btn btn-primary">Manage Installment</a>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <strong> Loan Installment</strong>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('loan/Loan/create_installment') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <select name="employee_id" id="employee_id" class="form-control" onchange="SelectToLoad(this.value),SelectToname(this.value),SelectAuto(this.value)" style="width: 395px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                 ...
                                 echo display('loan_id') ?>"  id="loan_id">
...
function SelectAuto(id){
    ...
    $.ajax({
        ...
        dataType: "JSON",
        success: function(data)
        { var installment=parseInt(data.installment_no) +1;
