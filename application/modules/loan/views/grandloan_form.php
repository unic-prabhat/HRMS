...
Add Loans</button> 
<a href="<?php echo base_url();?>loan/Loan/loan_view" class="btn btn-primary">Manage Granted loans</a>
                    ...
                    <?= form_open('loan/Loan/create_grandloan') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="permission_by" class="form-control" type="text" placeholder="<?php
                                 ...
                                 echo display('permission_by') ?>"  id="permission_by">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="repayment_amount" class="form-control"  placeholder="<?php echo display('repayment_amount') ?>" id="repayment_amount" >
                            </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="installment" class="form-control"  placeholder="<?php echo display('installment') ?>" id="installment" >
                            </div>
                        </div> 
                        ...
                        <div class="form-group text-right">
                            ...
                            <button type="submit" class="btn btn-success w-md m-b-5"><?php echo display('grand') ?></button>
                        </div>
                    <?php echo form_close() ?>
